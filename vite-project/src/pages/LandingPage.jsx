  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'}`}>
      ...
      {/* How It Works Section */}
       <section className={`py-20 px-6 md:px-12 transition-colors duration-700 ${
  theme === 'dark' ? 'custom-how-dark text-white' : 'custom-how-light text-gray-900'
}`}>
        ...
        <div className="grid md:grid-cols-3 gap-10 text-center">
          {[
            ...
            <div
              key={i}
              className={`group relative ${theme === 'dark' ? 'bg-gray-800 text-white' : 'bg-gray-100 text-gray-900'} rounded-lg shadow-lg overflow-hidden transition-all duration-500 ${card.color} hover:scale-105`}
            ...
            >
              ...
              <div
                className={`absolute inset-0 p-6 ${theme === 'dark' ? 'bg-gray-900 text-gray-200' : 'bg-white text-gray-700'} flex items-center justify-center transition-opacity duration-500 ${
